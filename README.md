About google-cloud-batch-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-batch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-batch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-batch
# for installing globally
pixi global install google-cloud-batch
```
...
It is possible to list all of the versions of `google-cloud-batch` available on your platform:
...
```
pixi search google-cloud-batch --channel conda-forge
```
